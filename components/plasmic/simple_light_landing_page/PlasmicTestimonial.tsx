...
import Avatar from "../../Avatar"; // plasmic-import: mia_DNxV4NCE/component
...
import sty from "./PlasmicTestimonial.module.css"; // plasmic-import: NeBI00mmTg9w/css

import QuoteDashesIcon from "./icons/PlasmicIcon__QuoteDashes"; // plasmic-import: szhsze-47a8q/icon
  ...
  return (
    ...
    >
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__zyiDc)}
      >
        <div
          className={classNames(
            projectcss.all,
        ...
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__bxD8N)}
        >
          <div
            className={classNames(
              projectcss.all,
