...
import sty from "./PlasmicFaq.module.css"; // plasmic-import: TlkL6zFY3lIz/css
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__giJgY)}
      >
        <div className={classNames(projectcss.all, sty.freeBox__y7Ltf)}>
          <div className={classNames(projectcss.all, sty.freeBox__jzLn)}>
            {renderPlasmicSlot({
